(function (window) {
    ...
    c3.generate = function (config) {
        ...
        var __subchart_show = getConfig(['subchart', 'show'], false),
            ...
            __subchart_hideAxis = getConfig(["subchart", "hideAxis"], false);
        ...
        var __legend_show = getConfig(['legend', 'show'], true),
            ...
            __legend_offset_x = getConfig(['legend', 'offset', 'x'], 0),
            __legend_offset_y = getConfig(['legend', 'offset', 'y'], 0),
            __legend_offset_alignX = getConfig(['legend', 'offset', 'alignX'], "center"),
            __legend_offset_alignY = getConfig(['legend', 'offset', 'alignY'], "bottom");
        ...
        */
        ...
        function redraw(options, transitions) {
            ...
            axes.subx.style("opacity", hideAxis || __subchart_hideAxis ? 0 : 1);
        ...
        function updateLegend(targetIds, options, transitions) {
            ...
            if (isLegendRight) {
                ...
                xForLegend = function (id) {
                    // TODO - add offsets for axis
                    var total = 0;
                    if(__legend_offset_alignX === "center") total += margins[steps[id]];
                    else if(__legend_offset_alignX === "left") total += 0;
                    else if(__legend_offset_alignX === "right") total += (currentWidth - totalLength);

                    return total + offsets[id] + __legend_offset_x;
                };
                yForLegend = function (id) {
                    // TODO - add offsets for axis
                    var total = 0;
                    if(__legend_offset_alignY === "top") total += -(currentHeight - maxHeight);
                    else if(__legend_offset_alignY === "bottom") total += 0;
                    else if(__legend_offset_alignY === "center") total += -((currentHeight * 0.5) - (maxHeight * 0.5));

                    return total + __legend_offset_y;
                };
            }
