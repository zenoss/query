...
# Normalize DESTDIR, a variable used for staged installs.
# This is helpful for non-root users and also during packaged builds.
#
...
# Normalize _PREFIX to avoid edge case where we hit a circular dependency
...
ifndef CHECK_TOOLS
    ...
    CHECK_TOOLS += $(JAVA) $(LN)  $(MKDIR) $(MVN)   $(PR)   $(SED) 
    CHECK_TOOLS += $(SORT) $(TAR) $(TEE)   $(TOUCH) $(XARGS)
...
ifeq "$(REQUIRES_JDK)" "1"
	...
	$(warning "Nothing to do be done for target $@")
endif
