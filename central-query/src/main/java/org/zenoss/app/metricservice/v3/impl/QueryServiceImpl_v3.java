...
package org.zenoss.app.metricservice.v3.impl;
...
@API
public class QueryServiceImpl_v3 implements QueryService {
    private static final Logger log = LoggerFactory.getLogger(QueryServiceImpl_v3.class);
