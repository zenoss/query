/* nvd3 version 1.8.1 (https://github.com/novus/nvd3) 2015-09-29 */
(function(){
...
(function() {
    ...
    nv.models.tooltip = function() {
        ...
        */
        var data = null;
        var gravity = 'none'   //Can be 'n','s','e','w'. Determines how tooltip is positioned.
        ...
        var calcTooltipPosition = function(pos, boundRect) {
            ...
            nv.dom.read(function() {
                ...
                switch (gravity) {
                    ...
                    case 'w':
                        ...
                        if (left + width > boundRect.width) left = pos[0] - width - distance;
                        if (tTop < scrollTop) top = scrollTop + 5;
                        if (tTop + height > scrollTop + windowHeight) top = scrollTop + windowHeight - tTop + top - height;
                        if (top + height + distance > boundRect.height) top = boundRect.height - height - distance;
                        break;
                    case 'n':
                ...
                if (chartContainer && isInteractiveLayer) {
                    nv.dom.read(function() {
                        ...
                        if (svgComp) {
                            ...
                            chartBound = chartContainer.getBoundingClientRect();
                        ...
                        calcTooltipPosition([left,top], chartBound);
                    });
                } else {
